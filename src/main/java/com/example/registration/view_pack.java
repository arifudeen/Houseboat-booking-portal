...
public class view_pack extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_test1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent book_int = new Intent(view_pack.this, Boat_Booking.class);
        ...
        txt = (TextView) findViewById(R.id.txt_pack);
        txt_des = (TextView) findViewById(R.id.txt_desc);
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        Intent verifyIntent = new Intent(view_pack.this, Boat_Booking.class);
